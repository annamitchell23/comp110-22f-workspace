...
def input_guess(expected_length: int) -> str:
    """Obtains guess of user (which is "expected length" long). If not expected length, prompts
    user for another guess. If expected length, returns guess of correct length"""
